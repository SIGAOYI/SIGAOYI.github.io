...
>BY ([童仲毅geeeeeeeeek@github](https://github.com/geeeeeeeeek/git-recipes/))——目前看到的关于Merge、Rebase最通俗易懂的wiki。
>这是一篇在原文([BY atlassian](https://www.atlassian.com/git/tutorials/merging-vs-rebasing))基础上演绎的译文。除非另行注明，页面上所有内容采用知识共享-署名(CC BY 2.5 AU)协议共享。
