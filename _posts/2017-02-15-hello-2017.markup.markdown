...
96年接触电脑，97年拨号上网，2017年才开始写博客，对于一个智商应该没有问题的人来说，似乎有些奇怪。

中间的20年去哪里了？

帝国、红警、星际、三角洲、跑跑卡丁车、石器时代....

草榴...

实况、FIFA、CS、求生之路、战地、澄海3C、DOTA....

*科科*

直到2013年阴差阳错的进入互联网公司，才知道原来程序是这样运行的，产品是这样设计的，我们是这样被玩大的。

接触GitHub有2年了，但真正成为一名低频Giter还是最近的事情，为了找一些可复用的代码包，重新捡起800年没修炼维护的英语阅读，一头扎入Git，才发现这里原来是如此[一片纯净的乐土](https://www.zhihu.com/question/28976652/answer/42804737) .....

伙伴告诉我GitHub上可以直接搭建博客，一小股好奇就这么驱动着我从创建仓库开始无休止的百度、google、bing、知乎、简书、CSDN，终于在搞崩溃了1次MAC系统、重装2次环境配置、N次`git commit` `git push\pull` `git merge` `git fetch`之后

一个非程序员

一个吃饱了撑的产(bei)品(guo)狗(xia)
